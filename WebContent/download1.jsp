	...
	<div class="row clearfix">
			...
			<div class="col-md-9 column">
				<div class="content_right pull-left col-lg-9">
					...
					<ul class="news down">
						<li><div class="down_img pull-left">
								<a href="xiazaixiangqing.jsp"><img
									src="images/MYSQL.png" width="80" height="80"></a>
							</div>
							<div class="down_con pull-left">
								<p>
									<a href="xiazaixiangqing.jsp" class="down_name"
										style="margin-left: 0px;">MySQL5.1参考手册官方简体中文版</a>
								</p>
								<p>
									<span>大小:<em>2.53MB</em></span><span style="margin-left: 5px;">上传时间：<em>2015-12-01</em></span><span
										style="margin-left: 5px;"><em></em></span>
								</p>
								<p class="dec">MySQL是一个关系型数据库管理系统，由瑞典 MySQL AB 公司开发，目前属于
									Oracle 旗下公司...</p>
							</div>
						</li>
