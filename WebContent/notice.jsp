...
//文档加载完后，获取所有动态信息
    $(function(){
    	//加载完后，要执行的代码就写在这匿名函数
    	$.get("http://localhost:8080/SCF/allCategorynotice",function(result){

    		//document.write(result);
    		//遍历result（json数组）
    		for(var i=0;i<result.length;i++){
        		$("#ct").append("<li><span class='glyphicon glyphicon-hand-right'></span><a href='#'>"+result[i].ntitle+"</a><span class='pull-right time'></span></li>")
        	} 
        },"json")
    })
				...
				<div class="content_right pull-left col-lg-9">
					<h3>
						韶关市计算机学会<span class="pull-right">当前位置：<a href="/index.php">首页</a>
							&gt;&gt; <a href="/xuehuigonggao.html" title="学会公告" target="_top">学会公告</a></span>
					</h3>
					<ul class="news" id="ct">
						<li><span class="glyphicon glyphicon-hand-right"></span><a
							href="xuehuigonggao.jsp">韶关市计算机学会成立</a><span
							class="pull-right time">【2019-02-11】</span></li>
					</ul>
					<style type="text/css">#content .content_right p {text-indent: 0;}</style>
				</div>
			</div>
		</div>
</div>
